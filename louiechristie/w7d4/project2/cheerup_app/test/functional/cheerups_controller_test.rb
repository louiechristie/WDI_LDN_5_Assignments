...
class CheerupsControllerTest < ActionController::TestCase
  ...
  test "should create cheerup" do
    assert_difference('Cheerup.count') do
      post :create, cheerup: { image_url: @cheerup.image_url, message: @cheerup.message, state: @cheerup.state, user_id: @cheerup.user_id }
    end
  ...
  test "should update cheerup" do
    put :update, id: @cheerup, cheerup: { image_url: @cheerup.image_url, message: @cheerup.message, state: @cheerup.state, user_id: @cheerup.user_id }
    assert_redirected_to cheerup_path(assigns(:cheerup))
  end
